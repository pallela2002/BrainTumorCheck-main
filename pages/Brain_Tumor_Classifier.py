    ...
    if y.strip() == "Safe":
        components.html(
            ...
            h1{
                ...
                background: -webkit-linear-gradient(0.25turn,#32CD32, #32CD32);
        ...
        components.html(
            ...
            <style>
            h1{
                background: -webkit-linear-gradient(0.25turn,#FF0000,#FF0000);
                -webkit-background-clip: text;
                -webkit-text-fill-color: transparent;
                font-family: "Source Sans Pro", sans-serif;
            }
        ...
        components.html(
            ...
            <style>
            h1{
                background: -webkit-linear-gradient(0.25turn,#800080, #FF00FF);
                -webkit-background-clip: text;
                -webkit-text-fill-color: transparent;
                font-family: "Source Sans Pro", sans-serif;
            }
            ...
            <h2>LOCATION:Base of the brain-behind the nose</h1>
            """
        )
